...
!(function (t, e) {
            ...
            return (
                ...
                (n._addTouchEventListeners = function () {
                    ...
                    if (this._touchSupported) {
                        ...
                        e(this._element.querySelectorAll('.carousel-item img')).on('dragstart.bs.carousel', function (
                            t
                        ) {
    ...
    function et(t, e, n, i) {
        ...
        if ('viewport' === i) r = J(s, o)
            ...
            var a = void 0
            'scrollParent' === i
                ? 'BODY' === (a = x(I(e))).nodeName && (a = t.ownerDocument.documentElement)
                        ...
                        var c = e.priority,
                            ...
                            h = {
                                primary: function (t) {
                                    var n = u[t]
                                    return (
                                        u[t] < l[t] && !e.escapeWithReference && (n = Math.max(u[t], l[t])), z({}, t, n)
                                    )
                                },
    ...
    var It = 'dropdown',
        ...
        Ft = (function () {
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    return (
                        (t = s(s(s({}, this.constructor.Default), e(this._element).data()), t)),
            ...
            return (
                ...
                (n.setElementContent = function (t, n) {
                    'object' != typeof n || (!n.nodeType && !n.jquery)
                        ? this.config.html
                            ? (this.config.sanitize && (n = Vt(n, this.config.whiteList, this.config.sanitizeFn)),
                              t.html(n))
                            : t.text(n)
                        : this.config.html
                ...
                (n._getOffset = function () {
                    ...
                    return (
                        'function' == typeof this.config.offset
                            ? (e.fn = function (e) {
                                  return (
                                      (e.offsets = s(s({}, e.offsets), t.config.offset(e.offsets, t.element) || {})), e
                                  )
                              })
                ...
                (n._getConfig = function (t) {
                    ...
                    return (
                        ...
                        'number' ==
                            typeof (t = s(s(s({}, this.constructor.Default), n), 'object' == typeof t && t ? t : {}))
    ...
    var le = 'scrollspy',
        ...
        fe = (function () {
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    if (
                        'string' != typeof (t = s(s({}, ue), 'object' == typeof t && t ? t : {})).target &&
    ...
    var me = e.fn.toast,
        ...
        _e = (function () {
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    return (
                        (t = s(s(s({}, ve), e(this._element).data()), 'object' == typeof t && t ? t : {})),
